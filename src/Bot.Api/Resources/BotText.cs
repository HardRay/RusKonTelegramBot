...
public static class BotText
{
    ...
    public const string CitiesStartMessage = "Окей, значит ты ищешь работу, давай я покажу тебе наши актуальные вакансии.\r\nПодскажи, в каком городе ты ищешь работу, или может, ты хочешь работать онлайн?";
    ...
    public const string DirectionStartMessage = "Отлично, теперь выбери направление, которое тебе нравится или посмотри все вакансии по выбранным параметрам";
    ...
    public const string SkipStepButton = "Пропустить этот шаг";
